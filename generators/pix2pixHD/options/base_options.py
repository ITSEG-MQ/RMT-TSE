...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default='models/generator_models/pix2pixHD', help='models are saved here')
        ...
        self.parser.add_argument('--label_nc', type=int, default=38, help='# of input label channels')
        self.parser.add_argument('--input_nc', type=int, default=3, help='# of input image channels')
        self.parser.add_argument('--output_nc', type=int, default=3, help='# of output image channels')

        # for setting inputs
        # self.parser.add_argument('--dataroot', type=str, default='data/a2d2')
        self.parser.add_argument('--dataroot', type=str, default='/media/yao/新加卷/a2d2')
